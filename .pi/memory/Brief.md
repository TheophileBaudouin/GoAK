...
The KitV2 gate and probes pass through the 2026-08-05 audit-fix wave (product 2.4.1): 71 product skills, 3 sourced MIT templates (REST, CLI, worker), router index 253 resources, strict catalog mode PASS, validator unit tests PASS (11/11, incl. the new snippet date-chain check), full Go gate PASS (gofmt, vet, lint 0, race, gosec 0, govulncheck 0), 15/15 probes PASS. 2026-08-06 language wave: 0 French residual on the kit instruction surface (accent-scan), recipes/patterns/anti-patterns/fiches all English (D-2026-08-06-01), capabilities known_limits structured (pi-workflows → partial), TEMPLATES.md desktop-app planned. Audit findings KVA-001…KVA-011 (2026-08-05) and KVA-101…110 (2026-08-06) closed; evidence docs/plans/2026-08-06-language-wave-and-fix-pipeline.md. Legacy agent-authored template scaffolds remain removed; grpc, microservice, monolith, cloud-service, and desktop-app stay roadmap-only. Pi-lens code findings are only marked false-positive when verified against actual code and contract; unresolved findings must be debugged or reported. 2026-08-06 ultra-specialized skills wave: 72 product skills, router index 278 resources (+25 artifacts: 11 stdlib pointers, 7 patterns, 4 anti-patterns, 2 sources, registry rule `naming`), gate PASS (validators, cognitive, probes 15/15, gofmt/vet/test/lint 0); plan docs/plans/2026-08-06-ultra-specialized-go-skills.md, report docs/research/2026-08-06-ultra-specialized-skills-report.md. 2026-08-06 routing guarantee wave (product 2.5.0): routing-quality gate — router/scenarios.json (22 scenarios) verified by .agent/router/run_scenarios.mjs against the shared runtime scoring kit-resource-router-scoring.ts (zero divergence, 22/22 PASS); prompt surface reduced (.pi/settings.json = rules+recipes, catalogs routed on demand); routing mandate strengthened (KitV2/AGENTS.md "routing is mandatory" + tool promptGuidelines naming default patterns); validate-kitv2.py check_router_scenarios (schema+linkage, node-free); metaproject tests 25 passed; gate PASS (validators, probes 15/15, gofmt/vet/lint); review APPROVE; plan docs/plans/2026-08-06-routing-guarantee.md.
