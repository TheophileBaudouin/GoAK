...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/TheophileBaudouin/GoAK/v2.6.0/install.sh | sh -s -- [target-dir]
#
# Environment:
#   GAK_REF    git ref to install (default: v2.6.0). Use GAK_REF=main for the
